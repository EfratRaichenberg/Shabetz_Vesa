CREATE DATABASE  IF NOT EXISTS `shabetz_vesa` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `shabetz_vesa`;
...
CREATE TABLE `passenger` (
  ...
  `Hour` varchar(45) NOT NULL,
  `Num_of_places` int DEFAULT '3',
  `Ramp_status` tinyint DEFAULT '0',
  `Leaftlat_status` tinyint DEFAULT '0',
...
INSERT INTO `passenger` VALUES (24,'אפרת רייכנברג','0556775678','פתח תקווה','גני הדר','אור יחזקאל 1','בלינסון','16:00',3,0,0),(25,'אפרת רייכנברג','0556775678','פתח תקווה','גני הדר','אור יחזקאל 1','בלינסון','16:00',3,0,0),(26,'אפרת רייכנברג','0556775678','פתח תקווה','גני הדר','אור יחזקאל 1','בלינסון','16:00',3,0,0),(27,' ','','','',' ','','',3,0,0);
...
CREATE TABLE `passengers_in_drive` (
  ...
  `Approved_by_passenger` tinyint NOT NULL DEFAULT '0',
  `Approved_by_volunteer` tinyint NOT NULL DEFAULT '0',
...
CREATE TABLE `satisfaction` (
  ...
  `Satsfaction_degree` int DEFAULT '1',
  `Passenger_id` int NOT NULL,
  `Date` datetime NOT NULL,
...
INSERT INTO `volunteer` VALUES (23,'1234','יאיר','בני ברק','רבי עקיבא','0554382376','yair@gmail.com',3,0,0,1,1),(34,'343556','דניאל','Petach Tikva','Trumpeldor','0523437098','Daniel@gmail.com',5,0,0,1,1);
...
--
-- Dumping events for database 'shabetz_vesa'
--

--
-- Dumping routines for database 'shabetz_vesa'
--
...
-- Dump completed on 2022-01-09  1:48:01
